...
| [CHANGE-00010](changes/change-00010-replace-commander-with-citty-for-cli-parser.md) | Done | 2026-05-31 | [ADR-00005](adrs/adr-00005-use-citty-for-cli-command-parser.md) | - | - | Replace Commander with citty for CLI parser — implement ADR-00005 while preserving the existing public CLI command and option contract. |
