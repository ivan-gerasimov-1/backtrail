...
| [CHANGE-00003](changes/change-00003-implement-cli-exec-subcommands.md) | Proposed | 2026-05-09 | - | - | - | Implement CLI exec subcommands — route exec workflows through explicit implement and create subcommands. |
