...
| [CHANGE-00010](changes/change-00010-implement-conditional-reversibility-sections.md) | Done | 2026-08-01 | [ADR-00005](adrs/adr-00005-conditional-reversibility-sections.md) | - | - | Implement conditional reversibility sections — omit rollback detail by default and require it only for high-impact work. |
