...
| [CHANGE-00009](changes/change-00009-implement-backtrail-cli-config-file.md) | Proposed | 2026-05-12 | [ADR-00003](adrs/adr-00003-backtrail-cli-config-file.md) | - | - | Implement Backtrail CLI config file — add config file creation, startup loading, and shared --config/-c behavior per ADR-00003. |
